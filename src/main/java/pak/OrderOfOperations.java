...
public class OrderOfOperations {
    ...
    public static String recognize(String s){              //method divide String on numbers and operators
        ...
        public static ArrayList<String>result(ArrayList<String> arrayList, String op1, String op2){
